...
### Full Raspberry Pi Software Accelerated ###
#
...
if(__name__ == '__main__'):
    ...
    while True:
        ...
        # Detection variable goes up to 1 or 2 even when no detectable
        # objects are onscreen, which is why condition is set to 3.
        if(detections > 3):
            if(recording == False):
